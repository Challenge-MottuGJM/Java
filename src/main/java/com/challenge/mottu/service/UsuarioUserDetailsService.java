...
public class UsuarioUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		return new User(usuario.getUsername(),usuario.getSenha(),usuario.getCargo().stream()
				.map(cargo -> new SimpleGrantedAuthority(cargo.getNome().toString())).collect(Collectors.toList()));
