...
| Motos     | GET         | /motos/moto_por_status              | Filtra motos por status                |
| Motos     | GET         | /motos/moto_por_modelo              | Filtra motos por modelo                |
| Motos     | GET         | /motos/moto_por_placa               | Filtra motos por placa                 |
